...
export function GameFieldView({
  ...
  return (
    <div className={cn("flex min-h-0 flex-1 flex-col overflow-hidden", className)}>
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-y-auto overscroll-y-contain xl:flex-row xl:overflow-hidden">
        <div className="flex min-h-0 flex-1 flex-col bg-field-chart-canvas p-2 max-xl:flex-none sm:p-3 xl:overflow-hidden xl:p-4">
          ...
          <LiveField3D
            ...
            className="min-h-0 flex-1 max-xl:flex-none"
          />
        </div>

        <aside className="shrink-0 border-t border-border bg-panel xl:w-[260px] xl:overflow-y-auto xl:border-l xl:border-t-0">
